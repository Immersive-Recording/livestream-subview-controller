...
export function loadDOM_API(): any {
    let s: any;
    s = {};
...
/** A file-like object of immutable, raw data. Blobs represent data that isn't necessarily in a JavaScript-native format. The File export interface  is based on Blob, inheriting blob functionality and expanding it to support files on the user's system. */
...
/** This Streams API export interface  provides a built-in byte length queuing strategy that can be used when constructing streams. */
...
/** A single CSS rule. There are several types of rules, listed in the export type constants section below. */
...
/** An object representing a single CSS @supports at-rule. It implements the CSSConditionRule export interface , and therefore the CSSRule and CSSGroupingRule export interface s with a export type value of 12 (CSSRule.SUPPORTS_RULE). */
...
export interface  CanvasUserexport interface  {
...
export interface  DOMImplementation {
    createDocument(namespace: string | null, qualifiedName: string | null, doctype?: Documentexport type | null): XMLDocument;
...
export interface  DOMParser {
    /**
     * Parses string using either the HTML or XML parser, according to type, and returns the resulting Document. export type can be "text/html" (which will invoke the HTML parser), or any of "text/xml", "application/xml", "application/xhtml+xml", or "image/svg+xml" (which will invoke the XML parser).
     * 
...
export interface  Document extends Node, DocumentAndElementEventHandlers, DocumentOrShadowRoot, GlobalEventHandlers, NonElementParentNode, ParentNode, XPathEvaluatorBase {
     ...
     */
    readonly doctype: Documentexport type | null;
    /**
    ...
    createEvent(eventexport interface : "AnimationEvent"): AnimationEvent;
    createEvent(eventexport interface : "AnimationPlaybackEvent"): AnimationPlaybackEvent;
    createEvent(eventexport interface : "AudioProcessingEvent"): AudioProcessingEvent;
    createEvent(eventexport interface : "BeforeUnloadEvent"): BeforeUnloadEvent;
    createEvent(eventexport interface : "ClipboardEvent"): ClipboardEvent;
    createEvent(eventexport interface : "CloseEvent"): CloseEvent;
    createEvent(eventexport interface : "CompositionEvent"): CompositionEvent;
    createEvent(eventexport interface : "CustomEvent"): CustomEvent;
    createEvent(eventexport interface : "DeviceLightEvent"): DeviceLightEvent;
    createEvent(eventexport interface : "DeviceMotionEvent"): DeviceMotionEvent;
    createEvent(eventexport interface : "DeviceOrientationEvent"): DeviceOrientationEvent;
    createEvent(eventexport interface : "DragEvent"): DragEvent;
    createEvent(eventexport interface : "ErrorEvent"): ErrorEvent;
    createEvent(eventexport interface : "Event"): Event;
    createEvent(eventexport interface : "Events"): Event;
    createEvent(eventexport interface : "FocusEvent"): FocusEvent;
    createEvent(eventexport interface : "FocusNavigationEvent"): FocusNavigationEvent;
    createEvent(eventexport interface : "GamepadEvent"): GamepadEvent;
    createEvent(eventexport interface : "HashChangeEvent"): HashChangeEvent;
    createEvent(eventexport interface : "IDBVersionChangeEvent"): IDBVersionChangeEvent;
    createEvent(eventexport interface : "InputEvent"): InputEvent;
    createEvent(eventexport interface : "KeyboardEvent"): KeyboardEvent;
    createEvent(eventexport interface : "ListeningStateChangedEvent"): ListeningStateChangedEvent;
    createEvent(eventexport interface : "MSGestureEvent"): MSGestureEvent;
    createEvent(eventexport interface : "MSMediaKeyMessageEvent"): MSMediaKeyMessageEvent;
    createEvent(eventexport interface : "MSMediaKeyNeededEvent"): MSMediaKeyNeededEvent;
    createEvent(eventexport interface : "MSPointerEvent"): MSPointerEvent;
    createEvent(eventexport interface : "MediaEncryptedEvent"): MediaEncryptedEvent;
    createEvent(eventexport interface : "MediaKeyMessageEvent"): MediaKeyMessageEvent;
    createEvent(eventexport interface : "MediaQueryListEvent"): MediaQueryListEvent;
    createEvent(eventexport interface : "MediaStreamErrorEvent"): MediaStreamErrorEvent;
    createEvent(eventexport interface : "MediaStreamEvent"): MediaStreamEvent;
    createEvent(eventexport interface : "MediaStreamTrackEvent"): MediaStreamTrackEvent;
    createEvent(eventexport interface : "MessageEvent"): MessageEvent;
    createEvent(eventexport interface : "MouseEvent"): MouseEvent;
    createEvent(eventexport interface : "MouseEvents"): MouseEvent;
    createEvent(eventexport interface : "MutationEvent"): MutationEvent;
    createEvent(eventexport interface : "MutationEvents"): MutationEvent;
    createEvent(eventexport interface : "OfflineAudioCompletionEvent"): OfflineAudioCompletionEvent;
    createEvent(eventexport interface : "OverflowEvent"): OverflowEvent;
    createEvent(eventexport interface : "PageTransitionEvent"): PageTransitionEvent;
    createEvent(eventexport interface : "PaymentRequestUpdateEvent"): PaymentRequestUpdateEvent;
    createEvent(eventexport interface : "PermissionRequestedEvent"): PermissionRequestedEvent;
    createEvent(eventexport interface : "PointerEvent"): PointerEvent;
    createEvent(eventexport interface : "PopStateEvent"): PopStateEvent;
    createEvent(eventexport interface : "ProgressEvent"): ProgressEvent;
    createEvent(eventexport interface : "PromiseRejectionEvent"): PromiseRejectionEvent;
    createEvent(eventexport interface : "RTCDTMFToneChangeEvent"): RTCDTMFToneChangeEvent;
    createEvent(eventexport interface : "RTCDataChannelEvent"): RTCDataChannelEvent;
    createEvent(eventexport interface : "RTCDtlsTransportStateChangedEvent"): RTCDtlsTransportStateChangedEvent;
    createEvent(eventexport interface : "RTCErrorEvent"): RTCErrorEvent;
    createEvent(eventexport interface : "RTCIceCandidatePairChangedEvent"): RTCIceCandidatePairChangedEvent;
    createEvent(eventexport interface : "RTCIceGathererEvent"): RTCIceGathererEvent;
    createEvent(eventexport interface : "RTCIceTransportStateChangedEvent"): RTCIceTransportStateChangedEvent;
    createEvent(eventexport interface : "RTCPeerConnectionIceErrorEvent"): RTCPeerConnectionIceErrorEvent;
    createEvent(eventexport interface : "RTCPeerConnectionIceEvent"): RTCPeerConnectionIceEvent;
    createEvent(eventexport interface : "RTCSsrcConflictEvent"): RTCSsrcConflictEvent;
    createEvent(eventexport interface : "RTCStatsEvent"): RTCStatsEvent;
    createEvent(eventexport interface : "RTCTrackEvent"): RTCTrackEvent;
    createEvent(eventexport interface : "SVGZoomEvent"): SVGZoomEvent;
    createEvent(eventexport interface : "SVGZoomEvents"): SVGZoomEvent;
    createEvent(eventexport interface : "SecurityPolicyViolationEvent"): SecurityPolicyViolationEvent;
    createEvent(eventexport interface : "ServiceWorkerMessageEvent"): ServiceWorkerMessageEvent;
    createEvent(eventexport interface : "SpeechRecognitionEvent"): SpeechRecognitionEvent;
    createEvent(eventexport interface : "SpeechSynthesisErrorEvent"): SpeechSynthesisErrorEvent;
    createEvent(eventexport interface : "SpeechSynthesisEvent"): SpeechSynthesisEvent;
    createEvent(eventexport interface : "StorageEvent"): StorageEvent;
    createEvent(eventexport interface : "TextEvent"): TextEvent;
    createEvent(eventexport interface : "TouchEvent"): TouchEvent;
    createEvent(eventexport interface : "TrackEvent"): TrackEvent;
    createEvent(eventexport interface : "TransitionEvent"): TransitionEvent;
    createEvent(eventexport interface : "UIEvent"): UIEvent;
    createEvent(eventexport interface : "UIEvents"): UIEvent;
    createEvent(eventexport interface : "VRDisplayEvent"): VRDisplayEvent;
    createEvent(eventexport interface : "VRDisplayEvent "): VRDisplayEvent ;
    createEvent(eventexport interface : "WebGLContextEvent"): WebGLContextEvent;
    createEvent(eventexport interface : "WheelEvent"): WheelEvent;
    createEvent(eventexport interface : string): Event;
    /**
...
export interface  Documentexport type extends Node, ChildNode {
    readonly name: string;
    readonly ownerDocument: Document;
...
export interface  Event {
    ...
    /**
     * Returns the export type of event, e.g. "click", "hashchange", or "submit".
     */
    readonly type: string;
    /**
...
/** EventTarget is a DOM export interface  implemented by objects that can receive events and may have listeners for them. */
export interface  EventTarget {
    /**
     * Appends an event listener for events whose export type attribute value is type. The callback argument sets the callback that will be invoked when the event is dispatched.
     * 
...
/** An object of this export type is returned by the files property of the HTML <input> element; this lets you access the list of files selected with the <input type="file"> element. It's also used for a list of files dropped into web content when using the drag and drop API; see the DataTransfer object for details on this usage. */
...
/** Provides a way to easily construct a set of key/value pairs representing form fields and their values, which can then be easily sent using the XMLHttpRequest.send() method. It uses the same format a form would use if the encoding export type were set to "multipart/form-data". */
...
export interface  HTMLButtonElement extends HTMLElement {
    ...
    formAction: string;
    /**
     * Used to override the encoding (formEncexport type attribute) specified on the form element.
     */
    formEnctype: string;
    /**
...
/** This Fetch API export interface  allows you to perform various actions on HTTP request and response headers. These actions include retrieving, setting, adding to, and removing. A Headers object has an associated header list, which is initially empty and consists of zero or more name and value pairs.  You can add to this using methods like append() (see Examples.) In all methods of this export interface , header names are matched by case-insensitive byte sequence. */
...
export interface  Mimeexport type {
    /**
...
/** Returns an array of Mimeexport type instances, each of which contains information about a supported browser plugins. This object is returned by NavigatorPlugins.mimeTypes. */
export interface  MimeTypeArray {
    readonly length: number;
    item(index: number): Mimeexport type | null;
    namedItem(name: string): Mimeexport type | null;
...
export interface  PaymentRequest extends EventTarget {
    ...
    readonly shippingType: PaymentShippingexport type | null;
    abort(): Promise<void>;
...
/** PerformanceMark is an abstract export interface  for PerformanceEntry objects with an entryexport type of "mark". Entries of this export type are created by calling performance.mark() to add a named DOMHighResTimeStamp (the mark) to the browser's performance timeline. */
...
/** PerformanceMeasure is an abstract export interface  for PerformanceEntry objects with an entryexport type of "measure". Entries of this export type are created by calling performance.measure() to add a named DOMHighResTimeStamp (the measure) between two marks to the browser's performance timeline. */
...
export interface  Plugin {
    ...
    readonly filename: string;
    /**
     * Returns the number of MIME types, represented by Mimeexport type objects, supported by the plugin.
     */
    readonly length: number;
    /**
    ...
    readonly name: string;
    /**
     * Returns the specified Mimeexport type object.
     */
    item(index: number): Mimeexport type | null;
    namedItem(name: string): Mimeexport type | null;
    [index: number]: MimeType;
...
export interface  RTCIceCandidate {
    ...
    readonly tcpType: RTCIceTcpCandidateexport type | null;
    readonly type: RTCIceCandidateexport type | null;
...
/** This Streams API export interface  represents a readable stream of byte data. The Fetch API offers a concrete instance of a ReadableStream through the body property of a Response object. */
...
/** A base export interface  used by the component transfer function export interface s. */
...
/** All of the SVG DOM export interface s that correspond directly to elements in the SVG language derive from the SVGElement export interface . */
...
/** Implemented by elements that support rendering child text content. It is inherited by various text-related export interface s, such as SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement and SVGTextPathElement. */
...
/** Used to reflect the zoomAndPan attribute, and is mixed in to other export interface s for elements that support this attribute. */
...
/** The URL export interface  represents an object providing static methods used for creating object URLs. */
...
/** This Web Workers API export interface  represents a background task that can be easily created and can send messages back to its creator. Creating a worker is as simple as calling the Worker() constructor and specifying a script to be run in the worker thread. */
...
/** This Streams API export interface  provides a standard abstraction for writing streaming data to a destination, known as a sink. This object comes with built-in backpressure and queuing. */
...
export interface  XMLHttpRequest extends XMLHttpRequestEventTarget {
     ...
     * 
     * Throws an "InvalidStateError" DOMException if responseexport type is not the empty string or "text".
     */
     ...
     * 
     * Throws an "InvalidStateError" DOMException if responseexport type is not the empty string or "document".
     */
     ...
     * 
     * Throws an "InvalidAccessError" DOMException if async is false, current global object is a Window object, and the timeout attribute is not zero or the responseexport type attribute is not the empty string.
     */
...
declare export type EventListenerOrEventListenerObject = EventListener | EventListenerObject;
...
declare namespace WebAssembly {
    ...
    export type Valueexport type = "f32" | "f64" | "i32" | "i64";
...
export type MutationRecordexport type = "attributes" | "characterData" | "childList";
...
export type Binaryexport type = "arraybuffer" | "blob";
export type BiquadFilterexport type = "allpass" | "bandpass" | "highpass" | "highshelf" | "lowpass" | "lowshelf" | "notch" | "peaking";
...
export type DOMParserSupportedexport type = "application/xhtml+xml" | "application/xml" | "image/svg+xml" | "text/html" | "text/xml";
export type DirectionSetting = "" | "lr" | "rl";
export type DisplayCaptureSurfaceexport type = "application" | "browser" | "monitor" | "window";
export type DistanceModelexport type = "exponential" | "inverse" | "linear";
export type DocumentReadyState = "complete" | "interactive" | "loading";
export type EndOfStreamError = "decode" | "network";
export type Endingexport type = "native" | "transparent";
...
export type GamepadHapticActuatorexport type = "vibration";
export type GamepadMappingexport type = "" | "standard";
...
export type Keyexport type = "private" | "public" | "secret";
...
export type MSCredentialexport type = "FIDO_2_0";
export type MSTransportexport type = "BT" | "Embedded" | "NFC" | "USB";
export type MSWebViewPermissionState = "allow" | "defer" | "deny" | "unknown";
export type MSWebViewPermissionexport type = "geolocation" | "media" | "pointerlock" | "unlimitedIndexedDBQuota" | "webnotifications";
export type MediaDeviceKind = "audioinput" | "audiooutput" | "videoinput";
export type MediaKeyMessageexport type = "individualization-request" | "license-release" | "license-renewal" | "license-request";
export type MediaKeySessionexport type = "persistent-license" | "temporary";
...
export type Navigationexport type = "back_forward" | "navigate" | "prerender" | "reload";
...
export type OrientationLockexport type = "any" | "landscape" | "landscape-primary" | "landscape-secondary" | "natural" | "portrait" | "portrait-primary" | "portrait-secondary";
export type Orientationexport type = "landscape-primary" | "landscape-secondary" | "portrait-primary" | "portrait-secondary";
export type Oscillatorexport type = "custom" | "sawtooth" | "sine" | "square" | "triangle";
export type OverSampleexport type = "2x" | "4x" | "none";
export type PanningModelexport type = "HRTF" | "equalpower";
export type PaymentComplete = "fail" | "success" | "unknown";
export type PaymentShippingexport type = "delivery" | "pickup" | "shipping";
...
export type PublicKeyCredentialexport type = "public-key";
...
export type RTCIceCredentialexport type = "oauth" | "password";
...
export type RTCIceTcpCandidateexport type = "active" | "passive" | "so";
...
export type RTCPriorityexport type = "high" | "low" | "medium" | "very-low";
...
export type RTCSdpexport type = "answer" | "offer" | "pranswer" | "rollback";
...
export type RTCStatsIceCandidateexport type = "host" | "peerreflexive" | "relayed" | "serverreflexive";
export type RTCStatsexport type = "candidatepair" | "datachannel" | "inboundrtp" | "localcandidate" | "outboundrtp" | "remotecandidate" | "session" | "track" | "transport";
...
export type Responseexport type = "basic" | "cors" | "default" | "error" | "opaque" | "opaqueredirect";
export type ScopedCredentialexport type = "ScopedCred";
...
export type Touchexport type = "direct" | "stylus";
...
export type Workerexport type = "classic" | "module";
export type XMLHttpRequestResponseexport type = "" | "arraybuffer" | "blob" | "document" | "json" | "text";
